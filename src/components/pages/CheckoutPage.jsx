    ...
    <div className="checkpout-page bg-birch-white">
      ...
      <div className="in-your-cart">
        ...
        <div className="order__column1 lg:w-1/2">
          ...
          <div className="line w-full border border-black mt-5 mb-5"></div>
          <div>
            <div className="calculations flex flex-col-2">
              <div className="summary flex flex-col gap-[35px] text-sm font-normal leading-4 tracking-normal text-left">
                <p>Items summary</p>
                <p>Delivery</p>
                <p>Discount</p>
              </div>
              <div className="prices flex flex-col gap-y-4 font-bold text-lg md:text-xl leading-6 items-center text-center text-black ml-auto">
                <p>135 euros</p>
                <p>10 euros</p>
                <p>60 euros</p>
              </div>
            ...
            <div className="total flex flex-col-2">
              <div className="font-bold text-lg md:text-xl leading-6 flex items-center text-center text-black">
                <p>Your total</p>
              </div>
              <div className="prices font-bold text-lg md:text-xl leading-6 flex items-center text-center text-black ml-auto">
                <p>65 euros</p>
              </div>
            </div>
          </div>
